...
*/
        ...
        create: function() {
            ...
            car = game.add.sprite(400, 225, 'car');
        ...
        find_path: function(x,y) {
            ...
            for (var i = 0; i < 1000; i += 20) {
                ...
                for (var j = 0; j < 1; j += 0.05) {
                    ...
                    var posx = this.math.catmullRomInterpolation([car.body.x+Math.cos(this.math.degToRad(car.body.angle))*10, new_x], j);
                    var posy = this.math.catmullRomInterpolation([car.body.y+Math.sin(this.math.degToRad(car.body.angle))*10, new_y], j);
        ...
        mueve_con_cuidao: function(x,y){
            ...
            for (var j = 0; j < 1; j += 0.1) {
                var posx = this.math.catmullRomInterpolation([car.body.x+(Math.cos(this.math.degToRad(car.body.angle))*10), final_x+(Math.cos(this.math.degToRad(car.body.angle))*10)], j);
                var posy = this.math.catmullRomInterpolation([car.body.y+(Math.sin(this.math.degToRad(car.body.angle))*10), final_y+(Math.sin(this.math.degToRad(car.body.angle))*10)], j);
