...
var pJS = function(tag_id, params){
  ...
  pJS.fn.particlesUpdate = function(){
    ...
    for(var i = 0; i < pJS.particles.array.length; i++){
	  ...
	  var factor_velocidad = 1/(window.innerWidth/1600);

          var ms = factor_velocidad * pJS.particles.move.speed/2;
          p.x += p.vx * ms;
          p.y += p.vy * ms;
  ...
  */
  ...
  pJS.fn.modes.grabParticle = function(p){
    ...
    if(pJS.interactivity.events.onhover.enable && pJS.interactivity.status == 'mousemove'){
      ...
      var mouse_fake_y = (pJS.interactivity.mouse.pos_y - window.top_elemento) * 1600 / particulas_header_h;
  ...
  pJS.fn.vendors.eventsListeners = function(){
    ...
    if(pJS.interactivity.events.onhover.enable || pJS.interactivity.events.onclick.enable){
      ...
      pJS.interactivity.el.addEventListener('touchmove', function(e){
        ...
        var pos_x = e.touches[0].pageX || e.changedTouches[0].pageX,
            pos_y = e.touches[0].pageY || e.changedTouches[0].pageY;
  ...
  */
  ...
  canvas_el.style.height = "100%";
	...
	window.top_elemento = 0;
        ...
        window.top_elemento = (w_h/2) - ((window.innerWidth / aspet_ratio)/2);
        contiene_canvas_el.style.top = window.top_elemento + "px";
